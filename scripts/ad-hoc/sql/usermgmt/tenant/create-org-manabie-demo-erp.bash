...
VALUES                    ('-2147483628',   '${TENANT_ID}', 'Manabie Demo ERP', '-2147483628', 'manabie-demo-erp', 'https://storage.googleapis.com/prod-tokyo-backend/user-upload/manabie_ic_splash.png',     'COUNTRY_JP', now(),      now(),      null      ) ON CONFLICT DO NOTHING;

INSERT INTO public.organization_auths
(organization_id, auth_project_id, auth_tenant_id)
VALUES(-2147483628, '${PROJECT_ID}', '${TENANT_ID}') ON CONFLICT DO NOTHING;
