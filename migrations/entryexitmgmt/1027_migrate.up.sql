DROP POLICY IF EXISTS rls_student_entryexit_records on "student_entryexit_records";
DROP POLICY IF EXISTS rls_student_entryexit_records_location on "student_entryexit_records";
