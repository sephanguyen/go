...
DROP TRIGGER IF EXISTS create_assignment ON public.assignments;

CREATE TRIGGER create_assignment AFTER INSERT OR UPDATE ON assignments FOR EACH ROW EXECUTE FUNCTION create_assignment_fn();
