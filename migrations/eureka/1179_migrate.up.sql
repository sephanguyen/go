...
DROP TRIGGER IF EXISTS trigger_study_plan_items_to_individual_study_plan_ins ON public.study_plan_items;
CREATE TRIGGER trigger_study_plan_items_to_individual_study_plan_ins
    AFTER INSERT ON public.study_plan_items
    REFERENCING NEW TABLE AS new_table
    FOR EACH STATEMENT EXECUTE FUNCTION public.trigger_study_plan_items_to_individual_study_plan();

DROP TRIGGER IF EXISTS trigger_study_plan_items_to_individual_study_plan_udt ON public.study_plan_items;
CREATE TRIGGER trigger_study_plan_items_to_individual_study_plan_udt
    AFTER UPDATE ON public.study_plan_items
    REFERENCING NEW TABLE AS new_table
    FOR EACH STATEMENT EXECUTE FUNCTION public.trigger_study_plan_items_to_individual_study_plan();
