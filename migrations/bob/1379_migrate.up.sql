...
ALTER TABLE lessons ADD COLUMN zoom_link TEXT,
                    ADD COLUMN zoom_owner_id TEXT,
                    ADD CONSTRAINT zoom_id_fk FOREIGN KEY (zoom_owner_id) REFERENCES public.zoom_account(zoom_id);
