ALTER TABLE IF EXISTS public.lesson_student_subscriptions
    ADD COLUMN IF NOT EXISTS course_slot int4 NULL,
    ADD COLUMN IF NOT EXISTS course_slot_per_week int4 NULL
;
...
DROP TABLE IF EXISTS public.student_course_slot;