CREATE OR REPLACE VIEW public.granted_permissions
AS SELECT ugm.user_id,
    p.permission_name,
    l1.location_id,
    ugm.resource_path
   FROM user_group_member ugm
     ...
     JOIN locations l1 ON l1.access_path like (l.access_path || '%') AND l.resource_path = l1.resource_path
