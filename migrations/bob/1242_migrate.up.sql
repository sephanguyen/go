...
VALUES('-2147483635', 'prod-kec-demo-fkl3m', 'KEC Demo', '-2147483635', 'kec-demo', '','COUNTRY_JP', now(), now(), null ) ON CONFLICT DO NOTHING;

INSERT INTO public.organization_auths
(organization_id, auth_project_id, auth_tenant_id)
VALUES(-2147483635, 'student-coach-e1e95', 'prod-kec-demo-fkl3m') ON CONFLICT DO NOTHING;
...
VALUES(-2147483635, 'KEC Demo', 'COUNTRY_JP', 1,1, null,false,now(), now(), false, null, null,'-2147483635') ON CONFLICT DO NOTHING;

/* KEC demo -2147483635 */
INSERT INTO public.location_types
(location_type_id, name, "display_name", resource_path, updated_at, created_at)
VALUES	('01FR4M51XJY9E77GSN4QZ1Q8M4','org','KEC demo', '-2147483635', now(), now()) ON CONFLICT DO NOTHING;
...
VALUES	('01FR4M51XJY9E77GSN4QZ1Q8N4', 'KEC demo','01FR4M51XJY9E77GSN4QZ1Q8M4',NULL, NULL, NULL, '-2147483635', now(), now(),'01FR4M51XJY9E77GSN4QZ1Q8N4') ON CONFLICT DO NOTHING;
...
/* Manabie B2C Internal -2147483634 */
--- Create Manabie B2C Internal Org ----
INSERT INTO organizations (organization_id, tenant_id, name, resource_path, domain_name, logo_url, country,created_at, updated_at, deleted_at)
VALUES('-2147483634', 'manabie-b2c-testing-mg761', 'Manabie B2C Internal', '-2147483634', 'manabie-b2c-internal', '', 'COUNTRY_JP', now(), now(), null) ON CONFLICT DO NOTHING;

INSERT INTO public.organization_auths
(organization_id, auth_project_id, auth_tenant_id)
VALUES(-2147483634, 'student-coach-e1e95', 'manabie-b2c-testing-mg761') ON CONFLICT DO NOTHING;

INSERT INTO schools (school_id, name, country, city_id, district_id, point, is_system_school, created_at, updated_at, is_merge, phone_number, deleted_at, resource_path)
VALUES(-2147483634, 'Manabie B2C Internal', 'COUNTRY_JP', 1, 1, null, false, now(), now(), false, null, null, '-2147483634') ON CONFLICT DO NOTHING;

--- Create Location ---- 

INSERT INTO public.location_types
(location_type_id, name, "display_name", resource_path, updated_at, created_at)
VALUES	('01FR4M51XJY9E77GSN4QZ1Q8M5', 'org', 'Manabie B2C Internal', '-2147483634', now(), now()) ON CONFLICT DO NOTHING;

INSERT INTO public.locations
(location_id, name, location_type, partner_internal_id, partner_internal_parent_id, parent_location_id, resource_path, updated_at, created_at,access_path)
VALUES	('01FR4M51XJY9E77GSN4QZ1Q8N5', 'Manabie B2C Internal','01FR4M51XJY9E77GSN4QZ1Q8M5',NULL, NULL, NULL, '-2147483634', now(), now(),'01FR4M51XJY9E77GSN4QZ1Q8N5') ON CONFLICT DO NOTHING;
