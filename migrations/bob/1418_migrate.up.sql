...
DROP POLICY IF EXISTS rls_staff_insert_location on "staff";
DROP POLICY IF EXISTS rls_staff_select_location on "staff";
DROP POLICY IF EXISTS rls_staff_update_location on "staff";
DROP POLICY IF EXISTS rls_staff_delete_location on "staff";
