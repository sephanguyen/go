...
WHERE config_key = 'architecture.course.bulk_class_allocation';


UPDATE internal_configuration_value 
SET config_value_type = 'boolean' 
WHERE config_key = 'architecture.course.bulk_class_allocation';
