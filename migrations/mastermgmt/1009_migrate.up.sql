...
-- ALTER TABLE public.user_group_member ADD CONSTRAINT fk__user_group_member__user_group_id FOREIGN KEY (user_group_id) REFERENCES public.user_group(user_group_id);
-- ALTER TABLE public.user_group_member ADD CONSTRAINT fk__user_group_member__user_id FOREIGN KEY (user_id) REFERENCES public.users(user_id);
...
-- ALTER TABLE public.granted_role ADD CONSTRAINT fk__granted_role__role_id FOREIGN KEY (role_id) REFERENCES public."role"(role_id);
-- ALTER TABLE public.granted_role ADD CONSTRAINT fk__granted_role__user_group_id FOREIGN KEY (user_group_id) REFERENCES public.user_group(user_group_id);
...
-- ALTER TABLE public.permission_role ADD CONSTRAINT fk__permission_role__permission_id FOREIGN KEY (permission_id) REFERENCES public."permission"(permission_id);
-- ALTER TABLE public.permission_role ADD CONSTRAINT fk__permission_role__role_id FOREIGN KEY (role_id) REFERENCES public."role"(role_id);
...
-- ALTER TABLE public.granted_role_access_path ADD CONSTRAINT fk__granted_role_access_path__granted_role_id FOREIGN KEY (granted_role_id) REFERENCES public.granted_role(granted_role_id);
-- ALTER TABLE public.granted_role_access_path ADD CONSTRAINT fk__granted_role_access_path__location_id FOREIGN KEY (location_id) REFERENCES public.locations(location_id);
...
-- ALTER TABLE public.locations ADD CONSTRAINT location_id_fk FOREIGN KEY (parent_location_id) REFERENCES public.locations(location_id);
-- ALTER TABLE public.locations ADD CONSTRAINT location_type_fk FOREIGN KEY (location_type) REFERENCES public.location_types(location_type_id);
