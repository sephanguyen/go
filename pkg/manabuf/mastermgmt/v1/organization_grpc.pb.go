...
func (c *organizationServiceClient) CreateOrganization(ctx context.Context, in *CreateOrganizationRequest, opts ...grpc.CallOption) (*CreateOrganizationResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mastermgmt.v1.OrganizationService/CreateOrganization", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _OrganizationService_CreateOrganization_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mastermgmt.v1.OrganizationService/CreateOrganization",
	}
...
var _OrganizationService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "mastermgmt.v1.OrganizationService",
	...
	Metadata: "mastermgmt/v1/organization.proto",
}
