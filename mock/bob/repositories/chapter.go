...
func (r *MockChapterRepo) DuplicateChapters(arg1 context.Context, arg2 database.QueryExecer, arg3 pgtype.TextArray) ([]*entities.CopiedChapter, error) {
...
func (r *MockChapterRepo) FindByBookID(arg1 context.Context, arg2 database.QueryExecer, arg3 string) ([]*entities.Chapter, error) {
	args := r.Called(arg1, arg2, arg3)
...
func (r *MockChapterRepo) FindSchoolIDsOnChapters(arg1 context.Context, arg2 database.QueryExecer, arg3 []string) ([]int32, error) {
	args := r.Called(arg1, arg2, arg3)
...
func (r *MockChapterRepo) FindWithFilter(arg1 context.Context, arg2 database.QueryExecer, arg3 []string, arg4 string, arg5 string, arg6 int, arg7 uint32, arg8 uint32) ([]*entities.Chapter, int, error) {
	args := r.Called(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8)

	if args.Get(0) == nil {
		return nil, args.Get(1).(int), args.Error(2)
	}
	return args.Get(0).([]*entities.Chapter), args.Get(1).(int), args.Error(2)
}
