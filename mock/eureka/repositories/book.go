...
func (r *MockBookRepo) DuplicateBook(arg1 context.Context, arg2 database.QueryExecer, arg3 pgtype.Text, arg4 pgtype.Text) (string, error) {
...
func (r *MockBookRepo) RetrieveAdHocBookByCourseIDAndStudentID(arg1 context.Context, arg2 database.QueryExecer, arg3 pgtype.Text, arg4 pgtype.Text) (*entities.Book, error) {
	args := r.Called(arg1, arg2, arg3, arg4)
...
func (r *MockBookRepo) RetrieveBookTreeByBookID(arg1 context.Context, arg2 database.QueryExecer, arg3 pgtype.Text) ([]*repositories.BookTreeInfo, error) {
	args := r.Called(arg1, arg2, arg3)
...
func (r *MockBookRepo) SoftDelete(arg1 context.Context, arg2 database.QueryExecer, arg3 pgtype.TextArray) error {
	args := r.Called(arg1, arg2, arg3)
	return args.Error(0)
}
