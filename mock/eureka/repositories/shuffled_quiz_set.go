...
func (r *MockShuffledQuizSetRepo) CalculateHighestSubmissionScore(arg1 context.Context, arg2 database.QueryExecer, arg3 pgtype.TextArray) ([]*repositories.CalculateHighestScoreResponse, error) {
...
func (r *MockShuffledQuizSetRepo) Create(arg1 context.Context, arg2 database.QueryExecer, arg3 *entities.ShuffledQuizSet) (pgtype.Text, error) {
	args := r.Called(arg1, arg2, arg3)
	return args.Get(0).(pgtype.Text), args.Error(1)
}

func (r *MockShuffledQuizSetRepo) GenerateExamLOSubmission(arg1 context.Context, arg2 database.QueryExecer, arg3 pgtype.Text) (*entities.ExamLOSubmission, error) {
	args := r.Called(arg1, arg2, arg3)
...
func (r *MockShuffledQuizSetRepo) GetBySessionID(arg1 context.Context, arg2 database.QueryExecer, arg3 pgtype.Text) (*entities.ShuffledQuizSet, error) {
	args := r.Called(arg1, arg2, arg3)
...
func (r *MockShuffledQuizSetRepo) GetByStudyPlanItemIdentities(arg1 context.Context, arg2 database.QueryExecer, arg3 []*repositories.StudyPlanItemIdentity) (entities.ShuffledQuizSets, error) {
	args := r.Called(arg1, arg2, arg3)
...
func (r *MockShuffledQuizSetRepo) GetCorrectnessInfo(arg1 context.Context, arg2 database.QueryExecer, arg3 pgtype.Text, arg4 pgtype.Text) (*entities.CorrectnessInfo, error) {
	args := r.Called(arg1, arg2, arg3, arg4)

	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
	return args.Get(0).(*entities.CorrectnessInfo), args.Error(1)
}

func (r *MockShuffledQuizSetRepo) GetExternalIDs(arg1 context.Context, arg2 database.QueryExecer, arg3 pgtype.Text) (pgtype.TextArray, error) {
	args := r.Called(arg1, arg2, arg3)
...
func (r *MockShuffledQuizSetRepo) GetRelatedLearningMaterial(arg1 context.Context, arg2 database.QueryExecer, arg3 pgtype.Text) (*entities.LearningMaterial, error) {
	args := r.Called(arg1, arg2, arg3)
...
func (r *MockShuffledQuizSetRepo) GetShuffledQuizSetIDsByOriginalQuizSetID(arg1 context.Context, arg2 database.QueryExecer, arg3 pgtype.Text) ([]string, error) {
	args := r.Called(arg1, arg2, arg3)
...
func (r *MockShuffledQuizSetRepo) UpdateTotalCorrectnessAndSubmissionHistory(arg1 context.Context, arg2 database.QueryExecer, arg3 *entities.ShuffledQuizSet) error {
	args := r.Called(arg1, arg2, arg3)
	return args.Error(0)
}

func (r *MockShuffledQuizSetRepo) UpsertFlashCardSubmission(arg1 context.Context, arg2 database.QueryExecer, arg3 pgtype.Text) (*entities.FlashCardSubmissionAnswerKey, error) {
	args := r.Called(arg1, arg2, arg3)

	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
	return args.Get(0).(*entities.FlashCardSubmissionAnswerKey), args.Error(1)
}

func (r *MockShuffledQuizSetRepo) UpsertLOSubmission(arg1 context.Context, arg2 database.QueryExecer, arg3 pgtype.Text) (*entities.LOSubmissionAnswerKey, error) {
	args := r.Called(arg1, arg2, arg3)

	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
	return args.Get(0).(*entities.LOSubmissionAnswerKey), args.Error(1)
}
