...
func (r *MockQuizSetRepo) BulkUpsert(arg1 context.Context, arg2 database.QueryExecer, arg3 []*entities.QuizSet) ([]*entities.QuizSet, error) {
	args := r.Called(arg1, arg2, arg3)
	return args.Get(0).(entities.QuizSets), args.Error(1)
}

func (r *MockQuizSetRepo) RetrieveByLoIDs(arg1 context.Context, arg2 database.QueryExecer, arg3 pgtype.TextArray) (entities.QuizSets, error) {
	args := r.Called(arg1, arg2, arg3)
	return args.Get(0).(entities.QuizSets), args.Error(1)
}

func (r *MockQuizSetRepo) GetTotalPointsByQuizSetID(arg1 context.Context, arg2 database.QueryExecer, arg3 pgtype.Text) (pgtype.Int4, error) {
	args := r.Called(arg1, arg2, arg3)
