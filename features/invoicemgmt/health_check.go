...
func (s *suite) healthCheckEndpointCalled(ctx context.Context) (context.Context, error) {
	...
	stepState.Response, stepState.ResponseErr = health.NewHealthClient(s.InvoiceMgmtConn).Check(contextWithValidVersion(ctx), &health.HealthCheckRequest{})
...
func (s *suite) invoicemgmtShouldReturnWithStatus(ctx context.Context, arg1, arg2 string) (context.Context, error) {
	stepState := StepStateFromContext(ctx)
