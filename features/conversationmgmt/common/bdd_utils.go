...
func (s *ConversationMgmtSuite) CheckReturnStatusCode(ctx context.Context, code string) (context.Context, error) {
...
func (s *ConversationMgmtSuite) WaitingForFCMIsSent(ctx context.Context) (context.Context, error) {
	time.Sleep(10 * time.Second)
	return ctx, nil
}

func (s *ConversationMgmtSuite) CheckReturnStatusCodeAndContainMsg(ctx context.Context, code string, errMsg string) (context.Context, error) {
	stepState := StepStateFromContext(ctx)
...
func (s *ConversationMgmtSuite) CheckReturnsErrorMessage(ctx context.Context, errMsg string) (context.Context, error) {
	stepState := StepStateFromContext(ctx)
...
func (s *ConversationMgmtSuite) WaitingForAgoraUserHasBeenCreated(ctx context.Context) (context.Context, error) {
	fmt.Printf("\nWaiting for Agora User has been created...\n")
...
func ContextWithResourcePath(ctx context.Context, rp string) context.Context {
	return contextWithResourcePath(ctx, rp)
}
...
func (s *ConversationMgmtSuite) MakeSampleNatsNotification(clientID string, traceID string, schoolID int32, notiType string) *ypb.NatsCreateNotificationRequest {
...
func (s *ConversationMgmtSuite) CheckNoneSelectTargetGroup(targetGroup *cpb.NotificationTargetGroup) bool {
	return utils.CheckNoneSelectTargetGroup(mappers.PbToNotificationTargetEnt(targetGroup))
}

func (s *ConversationMgmtSuite) GetGrantedLocations(ctx context.Context, notificationID string) ([]string, error) {
...
func (s *ConversationMgmtSuite) GetLocationIDsFromString(ctx context.Context, locationFilter string) ([]string, cpb.NotificationTargetGroupSelect, error) {
	stepState := StepStateFromContext(ctx)
