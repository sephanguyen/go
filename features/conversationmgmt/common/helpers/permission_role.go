...
func (helper *ConversationMgmtHelper) insertPermissionRoleForNotificationEnt(ctx context.Context, mapRoleAndRoleID map[string]string, resourcePath string) error {
...
func (helper *ConversationMgmtHelper) insertPermissionRoleForLocationEnt(ctx context.Context, mapRoleAndRoleID map[string]string, resourcePath string) error {
	ctx2 := interceptors.ContextWithJWTClaims(ctx, &interceptors.CustomClaims{
		Manabie: &interceptors.ManabieClaims{
			ResourcePath: resourcePath,
		},
...
func (helper *ConversationMgmtHelper) insertPermissionRoleForStudentEnt(ctx context.Context, mapRoleAndRoleID map[string]string, resourcePath string) error {
	ctx2 := interceptors.ContextWithJWTClaims(ctx, &interceptors.CustomClaims{
		Manabie: &interceptors.ManabieClaims{
			ResourcePath: resourcePath,
		},
...
func (helper *ConversationMgmtHelper) insertPermissionRoleForParentEnt(ctx context.Context, mapRoleAndRoleID map[string]string, resourcePath string) error {
	ctx2 := interceptors.ContextWithJWTClaims(ctx, &interceptors.CustomClaims{
		Manabie: &interceptors.ManabieClaims{
			ResourcePath: resourcePath,
		},
...
func (helper *ConversationMgmtHelper) insertPermissionRoleForStaffEnt(ctx context.Context, mapRoleAndRoleID map[string]string, resourcePath string) error {
	ctx2 := interceptors.ContextWithJWTClaims(ctx, &interceptors.CustomClaims{
		Manabie: &interceptors.ManabieClaims{
			ResourcePath: resourcePath,
		},
...
func (helper *ConversationMgmtHelper) insertPermissionRoleForUserGroupEnt(ctx context.Context, mapRoleAndRoleID map[string]string, resourcePath string) error {
	ctx2 := interceptors.ContextWithJWTClaims(ctx, &interceptors.CustomClaims{
		Manabie: &interceptors.ManabieClaims{
			ResourcePath: resourcePath,
		},
...
func (helper *ConversationMgmtHelper) insertPermissionRoleForUserEnt(ctx context.Context, mapRoleAndRoleID map[string]string, resourcePath string) error {
	ctx2 := interceptors.ContextWithJWTClaims(ctx, &interceptors.CustomClaims{
		Manabie: &interceptors.ManabieClaims{
			ResourcePath: resourcePath,
		},
...
func (helper *ConversationMgmtHelper) insertPermissionRoleForCourseEnt(ctx context.Context, mapRoleAndRoleID map[string]string, resourcePath string) error {
	ctx2 := interceptors.ContextWithJWTClaims(ctx, &interceptors.CustomClaims{
		Manabie: &interceptors.ManabieClaims{
			ResourcePath: resourcePath,
		},
