...
func (helper *ConversationMgmtHelper) CreateSchoolsForOrganization(ctx context.Context, orgID string) ([]*entities.School, error) {
...
func (helper *ConversationMgmtHelper) createASchoolLevel(ctx context.Context, _ string) (*entities.SchoolLevel, error) {
...
func (helper *ConversationMgmtHelper) createSchoolLevelGrade(ctx context.Context, schoolLevelID, orgID string) error {
	query := `
