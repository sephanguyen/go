...
func (s *Suite) healthCheckEndpointCalled(ctx context.Context) (context.Context, error) {
	...
	stepState.Response, stepState.ResponseErr = health.NewHealthClient(s.TimesheetConn).Check(contextWithValidVersion(ctx), &health.HealthCheckRequest{})
...
func (s *Suite) timesheetShouldHealthCheckReturnWithStatus(ctx context.Context, arg1, arg2 string) (context.Context, error) {
	stepState := StepStateFromContext(ctx)
