Feature: End live lesson room
  ...
  Scenario: teachers from same school join live lesson
    ...
    When user end live lesson
    Then returns "OK" status code
    And have a completed log with "1" joined attendees, "0" times getting room state, "0" times updating room state and "0" times reconnection
