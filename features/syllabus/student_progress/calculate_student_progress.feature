Feature: Calculate student progress
    ...
    Scenario Outline: authenticate calculate student progress
        Given <student_progress>a signed in "<role>"
        When calculate student progress
        Then <student_progress>returns "<msg>" status code
    ...
    Scenario Outline: Student done some los/assignments correctly and admin deletes topics
        ...
        And school admin delete "<index_topic_list>" topics
        When student calculate student progress
        Then <student_progress>returns "OK" status code
        And first pair topic score is "<topic_score_1>" and second pair topic score is "<topic_score_2>" and chapter score is "<chapter_score>"
