Feature: List submissions v4
    ...
    Scenario Outline: authenticate  list submissions v4
        Given <student_submission> a signed in "<role>"
        When user using list submissions v4 without student name
    ...
    Scenario Outline: student list submissions v4
        ...
        When user using list submissions v4 with "<value>" student name
        Then returns list student submissions correctly with "<value>"
