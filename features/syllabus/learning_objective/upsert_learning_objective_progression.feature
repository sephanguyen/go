Feature: Upsert LO Progression
    ...
    Scenario Outline: authenticate retrieve lo progression
        ...
        When student upsert lo progression with 1 answers
    ...
    Scenario: upsert lo progression
        Given <learning_objective>a signed in "school admin"
        ...
        And student upsert lo progression with 2 answers
        When student list lo progression
        Then <learning_objective>returns "OK" status code
        And there are 2 answers in the response
