...
func (helper *CommunicationHelper) CreateStudent(schoolAdmin *entities.Staff, grade *entities.GradeMaster, locIDs []string, hasParent bool, numOfParent int, schoolID string) (*entities.Student, error) {
...
func (helper *CommunicationHelper) RemoveParentFromStudent(admin *entity.Admin, student *entity.Student, parent *entity.User) error {
...
func (helper *CommunicationHelper) UpdateStudentWithParent(admin *entity.Admin, student *entity.Student) error {
	ctx, cancel := contextWithTokenAndTimeOut(context.Background(), admin.Token)
	defer cancel()
...
func (helper *CommunicationHelper) AddCourseToStudentWithLocation(admin *entities.Staff, student *entities.Student, courses []*entities.Course, mapCourseIDAndStudentIDs map[string][]string, locationIDs []string) error {
	ctx, cancel := contextWithTokenAndTimeOut(context.Background(), admin.Token)
	defer cancel()
...
func (helper *CommunicationHelper) CreateStudentWithParent(admin *entities.Staff, organizationID int32, grade *entities.GradeMaster, locIDs []string, optP *CreateStudentWithParentOpt, schoolID string) (*entities.Student, *entities.User, error) {
...
func (helper *CommunicationHelper) CreateStudentsWithSameParent(admin *entities.Staff, organizationID, currentGrade int32, grade *entities.GradeMaster, locIDs []string, optP *CreateStudentsWithSameParentOpt, schoolID string) ([]*entities.Student, *entities.User, error) {
...
func (helper *CommunicationHelper) newstudentInfo(organizationID int32, grade *entities.GradeMaster, locIDs []string, optP *CreateStudentOpt, schoolID string) (*entities.Student, *upb.CreateStudentRequest) {
...
func (helper *CommunicationHelper) createStudentEnrollmentStatus(ctx context.Context, resourcePath, studentID string, locationIDs []string) error {
