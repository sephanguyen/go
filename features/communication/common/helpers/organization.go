...
func (helper *CommunicationHelper) genarateSchoolNameCountryCityDistrict(arg1, arg2, arg3, arg4 string) *bob_entities.School {
...
func (helper *CommunicationHelper) insertsSchoolsIntoDB(ctx context.Context, schools []*bob_entities.School) (int32, error) {
...
func (helper *CommunicationHelper) generateOrganizationRole(ctx context.Context, defaultLocationID string, resourcePath string) error {
...
func (helper *CommunicationHelper) generateOrganizationAuth(ctx context.Context, schoolID string) error {
	stmt := `
...
func (helper *CommunicationHelper) newOrgWithOrgLocation(ctx context.Context) (int32, *entities.Location, error) {
...
func (helper *CommunicationHelper) CreateNewOrganization(orgType string) (*entities.Organization, error) {
	var (
