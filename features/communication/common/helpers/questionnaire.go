...
func (helper *CommunicationHelper) ParseQuestionFromString(str string) []*cpb.Question {
...
func (helper *CommunicationHelper) MakeAnAnswer(question *cpb.Question) *cpb.Answer {
