...
func (helper *CommunicationHelper) CreateLocationWithDB(ctx context.Context, resourcePath string, typeLocName string, parentLocID string, parentLocTypeID string) (*entities.Location, error) {
...
func (helper *CommunicationHelper) createLocationTypeWithDB(ctx context.Context, resourcePath string, typeLocName string, parentLocTypeID string) (string, error) {
