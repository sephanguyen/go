...
func (helper *CommunicationHelper) insertPermissionRoleForNotificationEnt(ctx context.Context, mapRoleAndRoleID map[string]string, resourcePath string) error {
...
func (helper *CommunicationHelper) insertPermissionRoleForLocationEnt(ctx context.Context, mapRoleAndRoleID map[string]string, resourcePath string) error {
	ctx2 := interceptors.ContextWithJWTClaims(ctx, &interceptors.CustomClaims{
		Manabie: &interceptors.ManabieClaims{
			ResourcePath: resourcePath,
		},
...
func (helper *CommunicationHelper) insertPermissionRoleForStudentEnt(ctx context.Context, mapRoleAndRoleID map[string]string, resourcePath string) error {
	ctx2 := interceptors.ContextWithJWTClaims(ctx, &interceptors.CustomClaims{
		Manabie: &interceptors.ManabieClaims{
			ResourcePath: resourcePath,
		},
...
func (helper *CommunicationHelper) insertPermissionRoleForParentEnt(ctx context.Context, mapRoleAndRoleID map[string]string, resourcePath string) error {
	ctx2 := interceptors.ContextWithJWTClaims(ctx, &interceptors.CustomClaims{
		Manabie: &interceptors.ManabieClaims{
			ResourcePath: resourcePath,
		},
...
func (helper *CommunicationHelper) insertPermissionRoleForStaffEnt(ctx context.Context, mapRoleAndRoleID map[string]string, resourcePath string) error {
	ctx2 := interceptors.ContextWithJWTClaims(ctx, &interceptors.CustomClaims{
		Manabie: &interceptors.ManabieClaims{
			ResourcePath: resourcePath,
		},
...
func (helper *CommunicationHelper) insertPermissionRoleForUserGroupEnt(ctx context.Context, mapRoleAndRoleID map[string]string, resourcePath string) error {
	ctx2 := interceptors.ContextWithJWTClaims(ctx, &interceptors.CustomClaims{
		Manabie: &interceptors.ManabieClaims{
			ResourcePath: resourcePath,
		},
...
func (helper *CommunicationHelper) insertPermissionRoleForUserEnt(ctx context.Context, mapRoleAndRoleID map[string]string, resourcePath string) error {
	ctx2 := interceptors.ContextWithJWTClaims(ctx, &interceptors.CustomClaims{
		Manabie: &interceptors.ManabieClaims{
			ResourcePath: resourcePath,
		},
...
func (helper *CommunicationHelper) insertPermissionRoleForCourseEnt(ctx context.Context, mapRoleAndRoleID map[string]string, resourcePath string) error {
	ctx2 := interceptors.ContextWithJWTClaims(ctx, &interceptors.CustomClaims{
		Manabie: &interceptors.ManabieClaims{
			ResourcePath: resourcePath,
		},
