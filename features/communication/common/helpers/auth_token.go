...
func (helper *CommunicationHelper) generateAuthenticationToken(sub string, template string) (string, error) {
...
func (helper *CommunicationHelper) GenerateValidAuthenticationToken(sub, userGroup string) (string, error) {
	return helper.generateAuthenticationToken(sub, "templates/"+userGroup+".template")
}

func (helper *CommunicationHelper) GenerateExchangeTokenCtx(ctx context.Context, userID, userGroup string) (string, error) {
