...
func (helper *CommunicationHelper) CreateGradeMasterForOrgazination(ctx context.Context, orgID string) ([]*entities.GradeMaster, error) {
...
func (helper *CommunicationHelper) getGradeMasterByOrg(ctx context.Context, orgID string) ([]*entities.GradeMaster, error) {
	grades := []*entities.GradeMaster{}
	query := `
