...
func (s *NotificationSuite) signedAsAccount(ctx context.Context, group string, orgID int64, grantedLocationIDs []string) (context.Context, error) {
...
func (s *NotificationSuite) aValidUser(ctx context.Context, opts ...userOption) (context.Context, error) {
	stepState := StepStateFromContext(ctx)
...
func (s *NotificationSuite) aSignedInStaff(ctx context.Context, roles []string, orgID int64, grantedLocationIDs []string) (context.Context, error) {
	stepState := StepStateFromContext(ctx)
...
func (s *NotificationSuite) createUserGroupWithRoleNames(ctx context.Context, roleNames []string, grantedLocationIDs []string, resourcePath int64) (string, error) {
...
func (s *NotificationSuite) GenerateIndividualIDs(ctx context.Context, isGeneric bool, numStudentNew int) ([]string, error) {
