...
func (s *NotificationSuite) StaffGrantedRoleAndOrgLocationLoggedInBackOfficeOfNewOrg(ctx context.Context, staffGrantedRole string) (context.Context, error) {
	organization, err := s.CommunicationHelper.CreateNewOrganization(helpers.OrganizationTypeNew)
	if err != nil {
		return ctx, err
	}
	...
	grades, err := s.CommunicationHelper.CreateGradeMasterForOrgazination(ctx, strconv.Itoa(int(organization.ID)))
	if err != nil {
		return ctx, err
	}
	...
	schools, err := s.CommunicationHelper.CreateSchoolsForOrganization(ctx, strconv.Itoa(int(organization.ID)))
	if err != nil {
		return ctx, err
	}
...
func (s *NotificationSuite) StaffGrantedRoleAndOrgLocationLoggedInBackOfficeOfCurrentOrg(ctx context.Context, staffGrantedRole string) (context.Context, error) {
	stepState := StepStateFromContext(ctx)
...
func (s *NotificationSuite) StaffGrantedRoleAndLocationsLoggedInBackOfficeOfCurrentOrg(ctx context.Context, staffGrantedRole string, idxsLocStr string) (context.Context, error) {
	stepState := StepStateFromContext(ctx)
...
func (s *NotificationSuite) StaffGrantedRoleLoggedInBackOfficeOfRespectiveOrg(ctx context.Context, numOrg, staffGrantedRole string) (context.Context, error) {
	stepState := StepStateFromContext(ctx)
...
func (s *NotificationSuite) StaffGrantedRoleOfJprepOrganizationWithDefaultLocationLoggedInBackOffice(ctx context.Context, staffGrantedRole string) (context.Context, error) {
	organization, err := s.CommunicationHelper.CreateNewOrganization(helpers.OrganizationTypeJPREP)
	if err != nil {
		return ctx, err
	}
...
func (s *NotificationSuite) StaffGrantedRoleOfManabieOrganizationWithDefaultLocationLoggedInBackOffice(ctx context.Context, staffGrantedRole string) (context.Context, error) {
	organization, err := s.CommunicationHelper.CreateNewOrganization(helpers.OrganizationTypeManabie)
	if err != nil {
		return ctx, err
	}
...
func (s *NotificationSuite) insertCurrentStaffIntoInternalUser(ctx context.Context) (context.Context, error) {
	stepState := StepStateFromContext(ctx)
...
func (s *NotificationSuite) AdminUpdateCurrentStaffGrantedLocationsTo(ctx context.Context, locationFilter string) (context.Context, error) {
	stepState := StepStateFromContext(ctx)
...
func (s *NotificationSuite) CreateSomeStaffsWithSomeRolesAndGrantedOrgLevelLocationOfCurrentOrganization(ctx context.Context) (context.Context, error) {
	stepState := StepStateFromContext(ctx)
