Feature: Create order Recurring Fee

  Scenario Outline: Create order recurring fee success
    Given prepare data for create order recurring fee with "<valid data>"
    When "school admin" submit order
    Then order recurring fee is created successfully
