...
func (s *suite) prepareDataForCreateOrderWithdrawFrequencyBasePackage(ctx context.Context, testcase string) (context.Context, error) {
	...
	case "valid withdrawal request with prorating and discount":
		...
		withdrawOrderReq = s.validWithdrawalRequestFrequencyBasePackage(&insertOrderReq, billItems, data)
	case "valid graduate request with prorating and discount":
		...
		withdrawOrderReq = s.validGraduationRequestFrequencyBasePackage(&insertOrderReq, billItems, data)
	case "empty billed at order with prorating and discount":
		...
		withdrawOrderReq = s.validWithdrawalRequestFrequencyBasePackageEmptyBilledAtOrder(&insertOrderReq, billItems, data)
	case "empty upcoming billing with prorating and discount":
		...
		insertOrderReq, billItems, data, err = s.createFrequencyBasePackageForWithdrawalEmptyUpcomingBilling(ctx, defaultOptionPrepareData)
		if err != nil {
			return StepStateToContext(ctx, stepState), err
		}
		withdrawOrderReq = s.validWithdrawalRequestFrequencyBasePackageEmptyUpcomingBilling(&insertOrderReq, billItems, data)
	case "empty billing items":
		defaultOptionPrepareData.BillingScheduleStartDate = time.Now()
		insertOrderReq, billItems, data, err = s.createFrequencyBasePackageForWithdrawalEmptyBillingItems(ctx, defaultOptionPrepareData)
		if err != nil {
			return StepStateToContext(ctx, stepState), err
		}
		withdrawOrderReq = s.validWithdrawalRequestFrequencyBasePackageEmptyBillingItems(&insertOrderReq, billItems, data)
	case "duplicate products":
		defaultOptionPrepareData.BillingScheduleStartDate = time.Now()
		insertOrderReq, billItems, data, err = s.createFrequencyBasePackageForWithdrawalDuplicateProducts(ctx, defaultOptionPrepareData)
		if err != nil {
			return StepStateToContext(ctx, stepState), err
		}
		withdrawOrderReq = s.validWithdrawalRequestFrequencyBasePackageDuplicateProducts(&insertOrderReq, billItems, data)
	}
...
func (s *suite) createOrderWithdrawFrequencyBasePackageSuccess(ctx context.Context) (context.Context, error) {
	stepState := StepStateFromContext(ctx)
...
func (s *suite) validWithdrawalRequestFrequencyBasePackageDuplicateProducts(oldRequest *pb.CreateOrderRequest, billItems []*entities.BillItem, data mockdata.DataForRecurringProduct) (req pb.CreateOrderRequest) {
	...
	billedAtOrderItems = append(billedAtOrderItems,
		...
		&pb.BillingItem{
			...
			Price:                   getFrequencyBasePrice(100, 2) / 2.0,
			Quantity:                &wrapperspb.Int32Value{Value: 2},
			TaxItem: &pb.TaxBillItem{
				TaxId:         data.TaxID,
				TaxPercentage: 20,
				TaxCategory:   pb.TaxCategory_TAX_CATEGORY_INCLUSIVE,
				TaxAmount:     getInclusivePercentTax(getPercentDiscountedPrice(getFrequencyBasePrice(100, 2)/2.0, 10), 20),
			},
			FinalPrice:      getPercentDiscountedPrice(getFrequencyBasePrice(100, 2)/2.0, 10),
			AdjustmentPrice: &wrapperspb.FloatValue{Value: -getPercentDiscountedPrice(getFrequencyBasePrice(100, 2), 10) * (1.0 / 2.0)},
			CourseItems: []*pb.CourseItem{
				{
					CourseId:   data.PackageCourses[0].CourseID.String,
					CourseName: fmt.Sprintf("course-%s", data.PackageCourses[0].CourseID.String),
			...
			DiscountItem: &pb.DiscountBillItem{
				...
				DiscountAmount:      getPercentDiscountValue(getFrequencyBasePrice(100, 2)/2.0, 10),
			},
		},
		// with 1/2 prorating
		&pb.BillingItem{
	...
	upcomingBillingItems = append(upcomingBillingItems,
		&pb.BillingItem{
			...
			Price:                   getFrequencyBasePrice(100, 2),
			Quantity:                &wrapperspb.Int32Value{Value: 2},
			TaxItem: &pb.TaxBillItem{
				TaxId:         data.TaxID,
				TaxPercentage: 20,
				TaxCategory:   pb.TaxCategory_TAX_CATEGORY_INCLUSIVE,
				TaxAmount:     getInclusivePercentTax(getPercentDiscountedPrice(getFrequencyBasePrice(100, 2), 10), 20),
			},
			FinalPrice:      getPercentDiscountedPrice(getFrequencyBasePrice(100, 2), 10),
			AdjustmentPrice: &wrapperspb.FloatValue{Value: -getPercentDiscountedPrice(getFrequencyBasePrice(100, 2), 10)},
			CourseItems: []*pb.CourseItem{
				{
					CourseId:   data.PackageCourses[0].CourseID.String,
					CourseName: fmt.Sprintf("course-%s", data.PackageCourses[0].CourseID.String),
			...
			DiscountItem: &pb.DiscountBillItem{
				...
				DiscountAmountType:  pb.DiscountAmountType_DISCOUNT_AMOUNT_TYPE_PERCENTAGE,
				DiscountAmountValue: 10,
				DiscountAmount:      getPercentDiscountValue(getFrequencyBasePrice(100, 2), 10),
			},
		},
		&pb.BillingItem{
			ProductId: data.ProductIDs[0],
	...
	req.OrderComment = "test withdraw frequency-base package"
...
func (s *suite) validWithdrawalRequestFrequencyBasePackageEmptyBillingItems(oldRequest *pb.CreateOrderRequest, billItems []*entities.BillItem, data mockdata.DataForRecurringProduct) (req pb.CreateOrderRequest) {
	orderItems := []*pb.OrderItem{}
	billedAtOrderItems := []*pb.BillingItem{}
	upcomingBillingItems := []*pb.BillingItem{}
...
func (s *suite) validWithdrawalRequestFrequencyBasePackageEmptyUpcomingBilling(oldRequest *pb.CreateOrderRequest, billItems []*entities.BillItem, data mockdata.DataForRecurringProduct) (req pb.CreateOrderRequest) {
	orderItems := []*pb.OrderItem{}
	billedAtOrderItems := []*pb.BillingItem{}
	upcomingBillingItems := []*pb.BillingItem{}
	...
	billedAtOrderItems = append(billedAtOrderItems,
		...
		&pb.BillingItem{
			...
			TaxItem: &pb.TaxBillItem{
				...
				TaxPercentage: 20,
				TaxCategory:   pb.TaxCategory_TAX_CATEGORY_INCLUSIVE,
				TaxAmount:     getInclusivePercentTax(getPercentDiscountedPrice(getFrequencyBasePrice(100, 2), 10)/2.0, 20),
			},
			FinalPrice:      getPercentDiscountedPrice(getFrequencyBasePrice(100, 2), 10) / 2.0,
			AdjustmentPrice: &wrapperspb.FloatValue{Value: -getPercentDiscountedPrice(getFrequencyBasePrice(100, 2), 10) * (1.0 / 2.0)},
			CourseItems: []*pb.CourseItem{
				{
					CourseId:   data.PackageCourses[0].CourseID.String,
...
func (s *suite) validWithdrawalRequestFrequencyBasePackageEmptyBilledAtOrder(oldRequest *pb.CreateOrderRequest, billItems []*entities.BillItem, data mockdata.DataForRecurringProduct) (req pb.CreateOrderRequest) {
	orderItems := []*pb.OrderItem{}
	billedAtOrderItems := []*pb.BillingItem{}
	upcomingBillingItems := []*pb.BillingItem{}
	...
	upcomingBillingItems = append(upcomingBillingItems,
		...
		&pb.BillingItem{
			...
			FinalPrice:      getPercentDiscountedPrice(getFrequencyBasePrice(100, 2), 10) / 2.0,
			AdjustmentPrice: &wrapperspb.FloatValue{Value: -getPercentDiscountedPrice(getFrequencyBasePrice(100, 2), 10) / 2.0},
			CourseItems: []*pb.CourseItem{
				{
					CourseId:   data.PackageCourses[0].CourseID.String,
					CourseName: fmt.Sprintf("course-%s", data.PackageCourses[0].CourseID.String),
...
func (s *suite) validWithdrawalRequestFrequencyBasePackageDisabledProrating(oldRequest *pb.CreateOrderRequest, billItems []*entities.BillItem, data mockdata.DataForRecurringProduct) (req pb.CreateOrderRequest) {
	orderItems := []*pb.OrderItem{}
	billedAtOrderItems := []*pb.BillingItem{}
	upcomingBillingItems := []*pb.BillingItem{}
	...
	billedAtOrderItems = append(billedAtOrderItems,
		&pb.BillingItem{
			...
			FinalPrice:      getPercentDiscountedPrice(getFrequencyBasePrice(100, 2), 10),
			AdjustmentPrice: &wrapperspb.FloatValue{Value: -getPercentDiscountedPrice(getFrequencyBasePrice(100, 0), 10)},
			CourseItems: []*pb.CourseItem{
				{
					CourseId:   data.PackageCourses[0].CourseID.String,
					CourseName: fmt.Sprintf("course-%s", data.PackageCourses[0].CourseID.String),
...
func (s *suite) validWithdrawalRequestFrequencyBasePackage(oldRequest *pb.CreateOrderRequest, billItems []*entities.BillItem, data mockdata.DataForRecurringProduct) (req pb.CreateOrderRequest) {
	orderItems := []*pb.OrderItem{}
	billedAtOrderItems := []*pb.BillingItem{}
	upcomingBillingItems := []*pb.BillingItem{}
...
func (s *suite) validGraduationRequestFrequencyBasePackage(oldRequest *pb.CreateOrderRequest, billItems []*entities.BillItem, data mockdata.DataForRecurringProduct) (req pb.CreateOrderRequest) {
	orderItems := []*pb.OrderItem{}
	billedAtOrderItems := []*pb.BillingItem{}
	upcomingBillingItems := []*pb.BillingItem{}
	...
	billedAtOrderItems = append(billedAtOrderItems,
		...
		&pb.BillingItem{
			...
			FinalPrice:      getPercentDiscountedPrice(getFrequencyBasePrice(100, 2)/2.0, 10),
			AdjustmentPrice: &wrapperspb.FloatValue{Value: -getPercentDiscountedPrice(getFrequencyBasePrice(100, 2), 10) * (1.0 / 4.0)},
			CourseItems: []*pb.CourseItem{
				{
					CourseId:   data.PackageCourses[0].CourseID.String,
					CourseName: fmt.Sprintf("course-%s", data.PackageCourses[0].CourseID.String),
...
func (s *suite) createFrequencyBasePackageForWithdrawalDisabledProrating(
	ctx context.Context,
	...
	options.InsertPackageCourseScheduleBased = false
...
func (s *suite) createFrequencyBasePackageForWithdrawal(
	ctx context.Context,
	options mockdata.OptionToPrepareDataForCreateOrderRecurringProduct,
) (
	req pb.CreateOrderRequest,
...
func (s *suite) createFrequencyBasePackageForWithdrawalEmptyUpcomingBilling(
	ctx context.Context,
	options mockdata.OptionToPrepareDataForCreateOrderRecurringProduct,
) (
	req pb.CreateOrderRequest,
...
func (s *suite) createFrequencyBasePackageForWithdrawalEmptyBillingItems(
	ctx context.Context,
	options mockdata.OptionToPrepareDataForCreateOrderRecurringProduct,
) (
	req pb.CreateOrderRequest,
...
func (s *suite) createFrequencyBasePackageForWithdrawalDuplicateProducts(
	ctx context.Context,
	options mockdata.OptionToPrepareDataForCreateOrderRecurringProduct,
) (
	req pb.CreateOrderRequest,
	...
	reqDuplicateProductID.OrderComment = "test withdraw frequency-base package"
