Feature: Modify Live Room State Chat Permission
  ...
  Scenario: teacher try to enable and after disable chat permission
    ...
    When user "enables" learners chat permission in the live room
