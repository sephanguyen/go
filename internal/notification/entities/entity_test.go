...
func TestEntity(t *testing.T) {
	...
	ents := []database.Entity{
		...
		&InfoNotificationTag{},
		&UserDeviceToken{},
		&NotificationStudentCourse{},
		&InfoNotificationAccessPath{},
		&NotificationClassMember{},
		&NotificationInternalUser{},
		&User{},
...
func TestEntities(t *testing.T) {
	...
	ents := []database.Entities{
		...
		&InfoNotificationMsgs{},
		&InfoNotifications{},
		&UserInfoNotifications{},
		&InfoNotificationsTags{},
		&UserDeviceTokens{},
		&NotificationStudentCourses{},
		&InfoNotificationAccessPaths{},
		&NotificationClassMembers{},
		&NotificationInternalUsers{},
		&Users{},
		&NotificationCourseFilters{},
		&NotificationLocationFilters{},
		&NotificationClassFilters{},
