...
func (s *InvoiceModifierService) DownloadPaymentFile(ctx context.Context, req *invoice_pb.DownloadPaymentFileRequest) (*invoice_pb.DownloadPaymentFileResponse, error) {
