...
func (s *InvoiceModifierService) RetrieveStudentPaymentMethod(ctx context.Context, req *invoice_pb.RetrieveStudentPaymentMethodRequest) (*invoice_pb.RetrieveStudentPaymentMethodResponse, error) {
