...
import (
	...
	pfutils "github.com/manabie-com/backend/internal/invoicemgmt/services/payment/payment_file_utils"
...
func (s *PaymentModifierService) CreateBulkPaymentValidation(ctx context.Context, req *invoice_pb.CreateBulkPaymentValidationRequest) (*invoice_pb.CreateBulkPaymentValidationResponse, error) {
...
func (s *PaymentModifierService) convertPayload(ctx context.Context, fileContents []byte, paymentMethod invoice_pb.PaymentMethod) (*pfutils.PaymentFile, error) {
	...
	file, err := fileConverter.ConvertFromBytesToPaymentFile(ctx, fileContents)
	if err != nil {
...
func (s *PaymentModifierService) validateFile(ctx context.Context, paymentFile *pfutils.PaymentFile, paymentDate *timestamppb.Timestamp, paymentMethod invoice_pb.PaymentMethod) (*pfutils.PaymentValidationResult, error) {
