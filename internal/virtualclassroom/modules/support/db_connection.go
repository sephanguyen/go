...
func (wdb *WrapperDBConnection) GetDB(resourcePath string) (database.Ext, error) {
	isUnleashToggled, err := wdb.unleashClient.IsFeatureEnabledOnOrganization("Virtual_Classroom_SwitchNewDBConnection_Switch_DB_To_LessonManagement", wdb.env, resourcePath)
	if err != nil {
