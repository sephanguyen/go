...
func VirtualLessonPollingRepoWithSqlMock() (*VirtualLessonPollingRepo, *testutil.MockDB) {
	r := &VirtualLessonPollingRepo{}
	return r, testutil.NewMockDB()
}

func TestVirtualLessonPollingRepo_Insert(t *testing.T) {
	t.Parallel()
	ctx, cancel := context.WithTimeout(context.Background(), time.Second)
	defer cancel()

	r, mockDB := VirtualLessonPollingRepoWithSqlMock()

	t.Run("err insert", func(t *testing.T) {
		e := &VirtualLessonPolling{}
		_, values := e.FieldMap()
