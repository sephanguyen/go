...
var (
	...
	errNotFollowTemplate       = errors.New("notFollowTemplate")
	errNotFollowParentTemplate = errors.New("notFollowParentTemplate")
	errDuplicationRow          = errors.New("duplicationRow")
	errAlreadyRegisteredRow    = errors.New("alreadyRegisteredRow")
	errMissingMandatory        = errors.New("missingMandatory")
	errInvalidNumberRow        = errors.New("invalidNumberRow")
)
