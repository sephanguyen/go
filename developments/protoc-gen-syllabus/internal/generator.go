...
func (g *generator) GenerateMethods() {
	...
	syllabus := figure.NewFigure("Syllabus", "", true)
	...
	genFile.P("/* *")
	genFile.P(syllabus.String())
	genFile.P("*/")
	genFile.P("// * Code generated by protoc-gen-syllabus. DO NOT EDIT.")
	genFile.P("// * versions:")
	genFile.P("// * - protoc-gen-syllabus ", GetVersion(debug.ReadBuildInfo))
