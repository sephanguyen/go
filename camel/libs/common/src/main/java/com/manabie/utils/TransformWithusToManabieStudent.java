...
import com.manabie.utils.entities.Parent;
import com.manabie.utils.entities.Student;
import com.manabie.utils.entities.Students;

public class TransformWithusToManabieStudent {
    ...
    public void exchange(Exchange exchange) {
        HashMap csvData = exchange.getIn().getBody(HashMap.class);
