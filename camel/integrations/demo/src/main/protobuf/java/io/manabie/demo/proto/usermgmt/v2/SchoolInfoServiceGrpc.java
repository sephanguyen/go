...
public final class SchoolInfoServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<io.manabie.demo.proto.usermgmt.v2.SchoolInfo.ImportSchoolInfoRequest,
      io.manabie.demo.proto.usermgmt.v2.SchoolInfo.ImportSchoolInfoResponse> getImportSchoolInfoMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ImportSchoolInfo",
      requestType = io.manabie.demo.proto.usermgmt.v2.SchoolInfo.ImportSchoolInfoRequest.class,
      responseType = io.manabie.demo.proto.usermgmt.v2.SchoolInfo.ImportSchoolInfoResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.manabie.demo.proto.usermgmt.v2.SchoolInfo.ImportSchoolInfoRequest,
      io.manabie.demo.proto.usermgmt.v2.SchoolInfo.ImportSchoolInfoResponse> getImportSchoolInfoMethod() {
    io.grpc.MethodDescriptor<io.manabie.demo.proto.usermgmt.v2.SchoolInfo.ImportSchoolInfoRequest, io.manabie.demo.proto.usermgmt.v2.SchoolInfo.ImportSchoolInfoResponse> getImportSchoolInfoMethod;
      ...
      synchronized (SchoolInfoServiceGrpc.class) {
        if ((getImportSchoolInfoMethod = SchoolInfoServiceGrpc.getImportSchoolInfoMethod) == null) {
          SchoolInfoServiceGrpc.getImportSchoolInfoMethod = getImportSchoolInfoMethod =
              io.grpc.MethodDescriptor.<io.manabie.demo.proto.usermgmt.v2.SchoolInfo.ImportSchoolInfoRequest, io.manabie.demo.proto.usermgmt.v2.SchoolInfo.ImportSchoolInfoResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ImportSchoolInfo"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.manabie.demo.proto.usermgmt.v2.SchoolInfo.ImportSchoolInfoRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.manabie.demo.proto.usermgmt.v2.SchoolInfo.ImportSchoolInfoResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void importSchoolInfo(io.manabie.demo.proto.usermgmt.v2.SchoolInfo.ImportSchoolInfoRequest request,
        io.grpc.stub.StreamObserver<io.manabie.demo.proto.usermgmt.v2.SchoolInfo.ImportSchoolInfoResponse> responseObserver) {
  ...
  public static final class SchoolInfoServiceStub
    ...
    /**
     */
    public void importSchoolInfo(io.manabie.demo.proto.usermgmt.v2.SchoolInfo.ImportSchoolInfoRequest request,
        io.grpc.stub.StreamObserver<io.manabie.demo.proto.usermgmt.v2.SchoolInfo.ImportSchoolInfoResponse> responseObserver) {
  ...
  public static final class SchoolInfoServiceBlockingStub
    ...
    /**
     */
    public io.manabie.demo.proto.usermgmt.v2.SchoolInfo.ImportSchoolInfoResponse importSchoolInfo(io.manabie.demo.proto.usermgmt.v2.SchoolInfo.ImportSchoolInfoRequest request) {
  ...
  public static final class SchoolInfoServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<io.manabie.demo.proto.usermgmt.v2.SchoolInfo.ImportSchoolInfoResponse> importSchoolInfo(
        io.manabie.demo.proto.usermgmt.v2.SchoolInfo.ImportSchoolInfoRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_IMPORT_SCHOOL_INFO:
          serviceImpl.importSchoolInfo((io.manabie.demo.proto.usermgmt.v2.SchoolInfo.ImportSchoolInfoRequest) request,
              (io.grpc.stub.StreamObserver<io.manabie.demo.proto.usermgmt.v2.SchoolInfo.ImportSchoolInfoResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              io.manabie.demo.proto.usermgmt.v2.SchoolInfo.ImportSchoolInfoRequest,
              io.manabie.demo.proto.usermgmt.v2.SchoolInfo.ImportSchoolInfoResponse>(
  ...
  private static abstract class SchoolInfoServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return io.manabie.demo.proto.usermgmt.v2.SchoolInfo.getDescriptor();
    }
