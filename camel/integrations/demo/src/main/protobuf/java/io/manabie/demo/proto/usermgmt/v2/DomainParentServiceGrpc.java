...
public final class DomainParentServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<io.manabie.demo.proto.usermgmt.v2.Parents.UpsertParentRequest,
      io.manabie.demo.proto.usermgmt.v2.Parents.UpsertParentResponse> getUpsertParentMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "UpsertParent",
      requestType = io.manabie.demo.proto.usermgmt.v2.Parents.UpsertParentRequest.class,
      responseType = io.manabie.demo.proto.usermgmt.v2.Parents.UpsertParentResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.manabie.demo.proto.usermgmt.v2.Parents.UpsertParentRequest,
      io.manabie.demo.proto.usermgmt.v2.Parents.UpsertParentResponse> getUpsertParentMethod() {
    io.grpc.MethodDescriptor<io.manabie.demo.proto.usermgmt.v2.Parents.UpsertParentRequest, io.manabie.demo.proto.usermgmt.v2.Parents.UpsertParentResponse> getUpsertParentMethod;
      ...
      synchronized (DomainParentServiceGrpc.class) {
        if ((getUpsertParentMethod = DomainParentServiceGrpc.getUpsertParentMethod) == null) {
          DomainParentServiceGrpc.getUpsertParentMethod = getUpsertParentMethod =
              io.grpc.MethodDescriptor.<io.manabie.demo.proto.usermgmt.v2.Parents.UpsertParentRequest, io.manabie.demo.proto.usermgmt.v2.Parents.UpsertParentResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "UpsertParent"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.manabie.demo.proto.usermgmt.v2.Parents.UpsertParentRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.manabie.demo.proto.usermgmt.v2.Parents.UpsertParentResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void upsertParent(io.manabie.demo.proto.usermgmt.v2.Parents.UpsertParentRequest request,
        io.grpc.stub.StreamObserver<io.manabie.demo.proto.usermgmt.v2.Parents.UpsertParentResponse> responseObserver) {
  ...
  public static final class DomainParentServiceStub
    ...
    /**
     */
    public void upsertParent(io.manabie.demo.proto.usermgmt.v2.Parents.UpsertParentRequest request,
        io.grpc.stub.StreamObserver<io.manabie.demo.proto.usermgmt.v2.Parents.UpsertParentResponse> responseObserver) {
  ...
  public static final class DomainParentServiceBlockingStub
    ...
    /**
     */
    public io.manabie.demo.proto.usermgmt.v2.Parents.UpsertParentResponse upsertParent(io.manabie.demo.proto.usermgmt.v2.Parents.UpsertParentRequest request) {
  ...
  public static final class DomainParentServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<io.manabie.demo.proto.usermgmt.v2.Parents.UpsertParentResponse> upsertParent(
        io.manabie.demo.proto.usermgmt.v2.Parents.UpsertParentRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_UPSERT_PARENT:
          serviceImpl.upsertParent((io.manabie.demo.proto.usermgmt.v2.Parents.UpsertParentRequest) request,
              (io.grpc.stub.StreamObserver<io.manabie.demo.proto.usermgmt.v2.Parents.UpsertParentResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              io.manabie.demo.proto.usermgmt.v2.Parents.UpsertParentRequest,
              io.manabie.demo.proto.usermgmt.v2.Parents.UpsertParentResponse>(
  ...
  private static abstract class DomainParentServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return io.manabie.demo.proto.usermgmt.v2.Parents.getDescriptor();
    }
