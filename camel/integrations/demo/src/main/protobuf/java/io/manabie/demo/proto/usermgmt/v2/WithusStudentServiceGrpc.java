...
public final class WithusStudentServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<io.manabie.demo.proto.usermgmt.v2.Student.ImportWithusManagaraBaseCSVRequest,
      io.manabie.demo.proto.usermgmt.v2.Student.ImportWithusManagaraBaseCSVResponse> getImportWithusManagaraBaseCSVMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ImportWithusManagaraBaseCSV",
      requestType = io.manabie.demo.proto.usermgmt.v2.Student.ImportWithusManagaraBaseCSVRequest.class,
      responseType = io.manabie.demo.proto.usermgmt.v2.Student.ImportWithusManagaraBaseCSVResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.manabie.demo.proto.usermgmt.v2.Student.ImportWithusManagaraBaseCSVRequest,
      io.manabie.demo.proto.usermgmt.v2.Student.ImportWithusManagaraBaseCSVResponse> getImportWithusManagaraBaseCSVMethod() {
    io.grpc.MethodDescriptor<io.manabie.demo.proto.usermgmt.v2.Student.ImportWithusManagaraBaseCSVRequest, io.manabie.demo.proto.usermgmt.v2.Student.ImportWithusManagaraBaseCSVResponse> getImportWithusManagaraBaseCSVMethod;
      ...
      synchronized (WithusStudentServiceGrpc.class) {
        if ((getImportWithusManagaraBaseCSVMethod = WithusStudentServiceGrpc.getImportWithusManagaraBaseCSVMethod) == null) {
          WithusStudentServiceGrpc.getImportWithusManagaraBaseCSVMethod = getImportWithusManagaraBaseCSVMethod =
              io.grpc.MethodDescriptor.<io.manabie.demo.proto.usermgmt.v2.Student.ImportWithusManagaraBaseCSVRequest, io.manabie.demo.proto.usermgmt.v2.Student.ImportWithusManagaraBaseCSVResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ImportWithusManagaraBaseCSV"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.manabie.demo.proto.usermgmt.v2.Student.ImportWithusManagaraBaseCSVRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.manabie.demo.proto.usermgmt.v2.Student.ImportWithusManagaraBaseCSVResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void importWithusManagaraBaseCSV(io.manabie.demo.proto.usermgmt.v2.Student.ImportWithusManagaraBaseCSVRequest request,
        io.grpc.stub.StreamObserver<io.manabie.demo.proto.usermgmt.v2.Student.ImportWithusManagaraBaseCSVResponse> responseObserver) {
  ...
  public static final class WithusStudentServiceStub
    ...
    /**
     */
    public void importWithusManagaraBaseCSV(io.manabie.demo.proto.usermgmt.v2.Student.ImportWithusManagaraBaseCSVRequest request,
        io.grpc.stub.StreamObserver<io.manabie.demo.proto.usermgmt.v2.Student.ImportWithusManagaraBaseCSVResponse> responseObserver) {
  ...
  public static final class WithusStudentServiceBlockingStub
    ...
    /**
     */
    public io.manabie.demo.proto.usermgmt.v2.Student.ImportWithusManagaraBaseCSVResponse importWithusManagaraBaseCSV(io.manabie.demo.proto.usermgmt.v2.Student.ImportWithusManagaraBaseCSVRequest request) {
  ...
  public static final class WithusStudentServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<io.manabie.demo.proto.usermgmt.v2.Student.ImportWithusManagaraBaseCSVResponse> importWithusManagaraBaseCSV(
        io.manabie.demo.proto.usermgmt.v2.Student.ImportWithusManagaraBaseCSVRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_IMPORT_WITHUS_MANAGARA_BASE_CSV:
          serviceImpl.importWithusManagaraBaseCSV((io.manabie.demo.proto.usermgmt.v2.Student.ImportWithusManagaraBaseCSVRequest) request,
              (io.grpc.stub.StreamObserver<io.manabie.demo.proto.usermgmt.v2.Student.ImportWithusManagaraBaseCSVResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              io.manabie.demo.proto.usermgmt.v2.Student.ImportWithusManagaraBaseCSVRequest,
              io.manabie.demo.proto.usermgmt.v2.Student.ImportWithusManagaraBaseCSVResponse>(
