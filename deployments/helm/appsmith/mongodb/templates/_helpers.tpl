...
mongodb.sh/chart: {{ include "mongodb.chart" . }}
...
*/}}
{{- define "mongodb.serviceAccountAnnotations" -}}
iam.gke.io/gcp-service-account: {{ include "mongodb.serviceAccountEmail" . }}
{{- end -}}

{{- define "mongodb.serviceAccountEmail" -}}
{{- printf "%s@%s.iam.gserviceaccount.com" (include "mongodb.serviceAccountName" .) .Values.serviceAccountEmailSuffix }}
{{- end -}}

{{- define "mongodb.serviceAccountName" -}}
{{- if eq "dorp" .Values.environment -}}
{{- printf "prod-%s" (include "mongodb.fullname" .) }}
{{- else -}}
{{- printf "%s-%s" .Values.environment (include "mongodb.fullname" .) }}
{{- end -}}
{{- end -}}
