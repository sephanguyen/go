...
DROP CONNECTOR IF EXISTS SINK_LESSON_MEMBERS_PUBLIC_INFO;
DROP STREAM IF EXISTS LESSON_MEMBERS_PUBLIC_INFO_V1 DELETE TOPIC;
DROP STREAM IF EXISTS LESSON_MEMBERS_STREAM_FORMATED_V1 DELETE TOPIC;
DROP STREAM IF EXISTS LESSONS_STREAM_FORMATED_V1 DELETE TOPIC;
DROP STREAM IF EXISTS LESSON_MEMBERS_STREAM_ORIGIN_V1;
DROP STREAM IF EXISTS LESSONS_STREAM_ORIGIN_V1;

CREATE STREAM IF NOT EXISTS LESSONS_STREAM_ORIGIN_V1 WITH (kafka_topic='{{ .Values.global.environment }}.kec.datalake.lessonmgmt.lessons', value_format='AVRO');
CREATE STREAM IF NOT EXISTS LESSON_MEMBERS_STREAM_ORIGIN_V1 WITH (kafka_topic='{{ .Values.global.environment }}.kec.datalake.lessonmgmt.lesson_members', value_format='AVRO');

CREATE STREAM IF NOT EXISTS LESSONS_STREAM_FORMATED_V1
    AS SELECT
         LESSONS_STREAM_ORIGIN_V1.AFTER->LESSON_ID AS KEY,
         AS_VALUE(LESSONS_STREAM_ORIGIN_V1.AFTER->LESSON_ID) AS LESSON_ID,
...
CREATE TABLE IF NOT EXISTS LESSONS_TABLE_FORMATED_V1 (KEY VARCHAR PRIMARY KEY) with (kafka_topic='{{ .Values.topicPrefix }}LESSONS_STREAM_FORMATED_V1', value_format='AVRO');

CREATE STREAM IF NOT EXISTS LESSON_MEMBERS_STREAM_FORMATED_V1
    AS SELECT
              CONCAT(LESSON_MEMBERS_STREAM_ORIGIN_V1.AFTER->USER_ID, '_', LESSON_MEMBERS_STREAM_ORIGIN_V1.AFTER->LESSON_ID) AS KEY,
...
CREATE STREAM IF NOT EXISTS LESSON_MEMBERS_STREAM_FORMATED_COMPOSE_KEY
    AS SELECT
        LESSON_MEMBERS_STREAM_FORMATED_V1.KEY AS KEY,
        LESSON_MEMBERS_STREAM_FORMATED_V1.USER_ID AS USER_ID,
        LESSON_MEMBERS_STREAM_FORMATED_V1.LESSON_ID AS LESSON_ID,
        LESSON_MEMBERS_STREAM_FORMATED_V1.UPDATED_AT AS UPDATED_AT, 
        LESSON_MEMBERS_STREAM_FORMATED_V1.CREATED_AT AS CREATED_AT,
        LESSON_MEMBERS_STREAM_FORMATED_V1.DELETED_AT AS DELETED_AT,
    ...
    FROM LESSON_MEMBERS_STREAM_FORMATED_V1
    PARTITION BY KEY
    EMIT CHANGES;

CREATE TABLE IF NOT EXISTS LESSON_MEMBERS_TABLE_FORMATED_V1 (KEY VARCHAR PRIMARY KEY) with (kafka_topic='{{ .Values.topicPrefix }}LESSON_MEMBERS_STREAM_FORMATED_COMPOSE_KEY', value_format='AVRO');

CREATE TABLE IF NOT EXISTS LESSON_MEMBERS_PUBLIC_INFO_V1 
    AS SELECT
    LESSONS_TABLE_FORMATED_V1.KEY AS LESSON_ID,
    LESSONS_TABLE_FORMATED_V1.CREATED_AT AS LESSONS_CREATED_AT,
    LESSONS_TABLE_FORMATED_V1.UPDATED_AT AS LESSONS_UPDATED_AT,
    LESSONS_TABLE_FORMATED_V1.DELETED_AT AS LESSONS_DELETED_AT,
    LESSONS_TABLE_FORMATED_V1.END_AT AS END_AT,
    LESSONS_TABLE_FORMATED_V1.LESSON_GROUP_ID AS LESSON_GROUP_ID,
    LESSONS_TABLE_FORMATED_V1.ROOM_ID AS ROOM_ID,
    LESSONS_TABLE_FORMATED_V1.LESSON_TYPE AS LESSON_TYPE,
    LESSONS_TABLE_FORMATED_V1.STATUS AS STATUS,
    LESSONS_TABLE_FORMATED_V1.STREAM_LEARNER_COUNTER AS STREAM_LEARNER_COUNTER,
    LESSONS_TABLE_FORMATED_V1.LEARNER_IDS AS LEARNER_IDS,
    LESSONS_TABLE_FORMATED_V1.NAME AS NAME,
    LESSONS_TABLE_FORMATED_V1.START_TIME AS START_TIME,
    LESSONS_TABLE_FORMATED_V1.END_TIME AS END_TIME,
    LESSONS_TABLE_FORMATED_V1.ROOM_STATE AS ROOM_STATE,
    LESSONS_TABLE_FORMATED_V1.CLASS_ID AS CLASS_ID,
    LESSONS_TABLE_FORMATED_V1.CENTER_ID AS CENTER_ID,
    LESSONS_TABLE_FORMATED_V1.TEACHING_METHOD AS TEACHING_METHOD,
    LESSONS_TABLE_FORMATED_V1.TEACHING_MEDIUM AS TEACHING_MEDIUM,
    LESSONS_TABLE_FORMATED_V1.SCHEDULING_STATUS AS SCHEDULING_STATUS,
    LESSONS_TABLE_FORMATED_V1.IS_LOCKED AS IS_LOCKED,

    LESSON_MEMBERS_TABLE_FORMATED_V1.KEY AS KEY,
    LESSON_MEMBERS_TABLE_FORMATED_V1.USER_ID AS STUDENT_ID,
    LESSON_MEMBERS_TABLE_FORMATED_V1.COURSE_ID AS COURSE_ID,
    LESSON_MEMBERS_TABLE_FORMATED_V1.UPDATED_AT AS LESSON_MEMBERS_UPDATED_AT,
    LESSON_MEMBERS_TABLE_FORMATED_V1.CREATED_AT AS LESSON_MEMBERS_CREATED_AT,
    LESSON_MEMBERS_TABLE_FORMATED_V1.DELETED_AT AS LESSON_MEMBERS_DELETED_AT,
    LESSON_MEMBERS_TABLE_FORMATED_V1.ATTENDANCE_STATUS AS ATTENDANCE_STATUS,
    LESSON_MEMBERS_TABLE_FORMATED_V1.ATTENDANCE_REMARK AS ATTENDANCE_REMARK,
    LESSON_MEMBERS_TABLE_FORMATED_V1.ATTENDANCE_NOTICE AS ATTENDANCE_NOTICE,
    LESSON_MEMBERS_TABLE_FORMATED_V1.ATTENDANCE_REASON AS ATTENDANCE_REASON,
    LESSON_MEMBERS_TABLE_FORMATED_V1.ATTENDANCE_NOTE AS ATTENDANCE_NOTE
    FROM LESSON_MEMBERS_TABLE_FORMATED_V1 JOIN LESSONS_TABLE_FORMATED_V1
    ON LESSON_MEMBERS_TABLE_FORMATED_V1.LESSON_ID = LESSONS_TABLE_FORMATED_V1.KEY;
...
CREATE SINK CONNECTOR SINK_LESSON_MEMBERS_PUBLIC_INFO WITH (
      ...
      'insert.mode'='upsert',
      'table.name.format'='public.lesson_members',
