...
CREATE STREAM IF NOT EXISTS USERS_STREAM_ORIGIN   WITH (kafka_topic='prod.tokyo.bob.public.users', value_format='AVRO');
...
CREATE  STREAM IF NOT EXISTS STUDENT_STREAM_ORIGIN  WITH (kafka_topic='prod.tokyo.bob.public.students', value_format='AVRO');
