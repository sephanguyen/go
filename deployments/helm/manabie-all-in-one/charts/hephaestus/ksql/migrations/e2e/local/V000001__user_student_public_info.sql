...
CREATE STREAM IF NOT EXISTS USERS_STREAM_ORIGIN_V3   WITH (kafka_topic='local.e2e.bob.public.users', value_format='AVRO');
...
CREATE  STREAM IF NOT EXISTS STUDENT_STREAM_ORIGIN_V3  WITH (kafka_topic='local.e2e.bob.public.students', value_format='AVRO');
