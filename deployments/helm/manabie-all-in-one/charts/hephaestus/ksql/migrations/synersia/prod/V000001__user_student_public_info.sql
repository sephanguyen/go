...
CREATE STREAM IF NOT EXISTS USERS_STREAM_ORIGIN   WITH (kafka_topic='prod.synersia.bob.public.users', value_format='AVRO');
...
CREATE  STREAM IF NOT EXISTS STUDENT_STREAM_ORIGIN  WITH (kafka_topic='prod.synersia.bob.public.students', value_format='AVRO');
