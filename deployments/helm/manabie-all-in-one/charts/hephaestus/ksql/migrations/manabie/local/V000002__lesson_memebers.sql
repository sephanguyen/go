...
CREATE STREAM IF NOT EXISTS LESSONS_STREAM_ORIGIN_V1   WITH (kafka_topic='local.manabie.bob.public.lessons', value_format='AVRO');
...
CREATE STREAM IF NOT EXISTS LESSON_MEMBERS_STREAM_ORIGIN_V1  WITH (kafka_topic='local.manabie.bob.public.lesson_members', value_format='AVRO');
