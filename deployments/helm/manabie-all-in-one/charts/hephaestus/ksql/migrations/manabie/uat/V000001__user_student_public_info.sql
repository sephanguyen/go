...
CREATE STREAM IF NOT EXISTS USERS_STREAM_ORIGIN   WITH (kafka_topic='uat.manabie.bob.public.users', value_format='AVRO');
...
CREATE  STREAM IF NOT EXISTS STUDENT_STREAM_ORIGIN  WITH (kafka_topic='uat.manabie.bob.public.students', value_format='AVRO');
...
-- created manually
CREATE SINK CONNECTOR SINK_BASIC_USER_INFO_NEW WITH (
