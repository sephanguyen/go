...
CREATE STREAM IF NOT EXISTS SCHOOL_COURSE_STREAM_ORIGIN_V1 WITH (kafka_topic='{{ .Values.global.environment }}.kec.datalake.bob.school_course', value_format='AVRO');
CREATE STREAM IF NOT EXISTS SCHOOL_COURSE_STREAM_FORMATED_V1
    AS SELECT
        SCHOOL_COURSE_STREAM_ORIGIN_V1.AFTER->SCHOOL_COURSE_ID AS SCHOOL_COURSE_ID,
...
CREATE STREAM IF NOT EXISTS SCHOOL_INFO_STREAM_ORIGIN_V1 WITH (kafka_topic='{{ .Values.global.environment }}.kec.datalake.bob.school_info', value_format='AVRO');
CREATE STREAM IF NOT EXISTS SCHOOL_INFO_STREAM_FORMATED_V1
    AS SELECT
        SCHOOL_INFO_STREAM_ORIGIN_V1.AFTER->SCHOOL_ID AS SCHOOL_ID,
...
CREATE STREAM IF NOT EXISTS SCHOOL_COURSE_SCHOOL_INFO_PUBLIC_INFO_V1 
AS SELECT
    SCHOOL_COURSE_STREAM_FORMATED_V1.SCHOOL_COURSE_ID AS SCHOOL_COURSE_ID,
    SCHOOL_COURSE_STREAM_FORMATED_V1.SCHOOL_COURSE_NAME AS SCHOOL_COURSE_NAME,
    SCHOOL_COURSE_STREAM_FORMATED_V1.SCHOOL_COURSE_NAME_PHONETIC AS SCHOOL_COURSE_NAME_PHONETIC,
    SCHOOL_COURSE_STREAM_FORMATED_V1.IS_ARCHIVED AS SCHOOL_COURSE_IS_ARCHIVED,
    SCHOOL_COURSE_STREAM_FORMATED_V1.SCHOOL_COURSE_PARTNER_ID AS SCHOOL_COURSE_PARTNER_ID,
    SCHOOL_COURSE_STREAM_FORMATED_V1.CREATED_AT AS SCHOOL_COURSE_CREATED_AT,
    SCHOOL_COURSE_STREAM_FORMATED_V1.UPDATED_AT AS SCHOOL_COURSE_UPDATED_AT,
    SCHOOL_COURSE_STREAM_FORMATED_V1.DELETED_AT AS SCHOOL_COURSE_DELETED_AT,

    SCHOOL_INFO_STREAM_FORMATED_V1.SCHOOL_ID AS SCHOOL_ID,
    SCHOOL_INFO_STREAM_FORMATED_V1.SCHOOL_NAME AS SCHOOL_NAME,
    SCHOOL_INFO_STREAM_FORMATED_V1.SCHOOL_NAME_PHONETIC AS SCHOOL_NAME_PHONETIC,
    SCHOOL_INFO_STREAM_FORMATED_V1.SCHOOL_LEVEL_ID AS SCHOOL_LEVEL_ID,
    SCHOOL_INFO_STREAM_FORMATED_V1.IS_ARCHIVED AS SCHOOL_INFO_IS_ARCHIVED,
    SCHOOL_INFO_STREAM_FORMATED_V1.SCHOOL_PARTNER_ID AS SCHOOL_PARTNER_ID,
    SCHOOL_INFO_STREAM_FORMATED_V1.ADDRESS AS ADDRESS,
    SCHOOL_INFO_STREAM_FORMATED_V1.CREATED_AT AS SCHOOL_INFO_CREATED_AT,
    SCHOOL_INFO_STREAM_FORMATED_V1.UPDATED_AT AS SCHOOL_INFO_UPDATED_AT,
    SCHOOL_INFO_STREAM_FORMATED_V1.DELETED_AT AS SCHOOL_INFO_DELETED_AT

FROM SCHOOL_INFO_STREAM_FORMATED_V1 
JOIN SCHOOL_COURSE_STREAM_FORMATED_V1 WITHIN 2 HOURS ON SCHOOL_INFO_STREAM_FORMATED_V1.SCHOOL_ID = SCHOOL_COURSE_STREAM_FORMATED_V1.SCHOOL_ID;
