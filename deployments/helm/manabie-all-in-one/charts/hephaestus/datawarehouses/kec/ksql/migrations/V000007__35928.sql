...
CREATE STREAM IF NOT EXISTS CLASSROOM_STREAM_ORIGIN_V1 WITH (kafka_topic='{{ .Values.global.environment }}.kec.datalake.bob.classroom', value_format='AVRO');
...
CREATE SINK CONNECTOR IF NOT EXISTS SINK_CLASSROOM_PUBLIC_INFO WITH (
      ...
      'insert.mode'='upsert',
      'table.name.format'='bob.classroom_public_info',
