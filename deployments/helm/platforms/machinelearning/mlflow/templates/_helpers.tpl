...
{{- printf "%s-mlflow" .Values.environment }}
{{- end }}

{{/*
Annotate service account
*/}}
{{- define "mlflow.serviceAccountAnnotations" -}}
iam.gke.io/gcp-service-account: {{ printf "%s@%s.iam.gserviceaccount.com" (include "mlflow.serviceAccountName" .) .Values.serviceAccountEmailSuffix }}
{{- end }}
