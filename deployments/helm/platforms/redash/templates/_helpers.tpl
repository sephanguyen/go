...
{{- printf "%s-redash" .Values.environment }}
{{- end }}

{{- define "redash.serviceAccountEmail" -}}
{{ printf "%s@%s.iam.gserviceaccount.com" (include "redash.serviceAccountName" .) .Values.serviceAccountEmailSuffix }}
{{- end }}

{{/*
Annotate service account
*/}}
{{- define "redash.serviceAccountAnnotations" -}}
iam.gke.io/gcp-service-account: {{ printf "%s@%s.iam.gserviceaccount.com" (include "redash.serviceAccountName" .) .Values.serviceAccountEmailSuffix }}
{{- end }}

{{- define "virtualservice.redash.tpl" -}}
apiVersion: networking.istio.io/v1beta1
kind: VirtualService
metadata:
  name: {{ .Chart.Name }}-redash
spec:
  hosts:
...
{{/*
Alloydb Proxy helper for redash
*/}}
{{- define "redash.alloydbProxy.tpl" -}}
- name: alloydb-auth-proxy
  ...
  securityContext:
    runAsNonRoot: true
  resources:
    {{- toYaml .Values.alloydbProxy.resources | nindent 4 }}
{{- end -}}